...
function renderIntro() {
  ...
  setHTML(`
    ...
    ${shameHtml()}
    <div class="card">
      <label><input type="checkbox" id="ack1"> I am aware my productivity today has been... fucked up UMM IG?</label>
...
const ROASTS = [
  ...
  "A study shows you'll feel guilty about this in exactly 7 minutes. ",
];
